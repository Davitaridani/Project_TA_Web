			...
			<div class="blocks-items-card">
				<div class="row">
					<div class="col-md-4">
						<div class="card">
							<div class="pict">
								<img src="{{ asset('assets/img/prewedding/prewedding (1).jpg') }}" alt="" class="img card-img">
							</div>
					...
					<div class="col-md-4">
						<div class="card">
							<div class="pict">
								<img src="{{ asset('assets/img/prewedding/prewedding (2).jpg') }}" alt="" class="img card-img">
							</div>
							<div class="card-body text-center">
								<div class="title-card ">
									<h3>Paket B</h3>
					...
					<div class="col-md-4">
						<div class="card">
							<div class="pict">
								<img src="{{ asset('assets/img/prewedding/prewedding (7).jpg') }}" alt="" class="img card-img">
							</div>
							<div class="card-body text-center">
								<div class="title-card ">
									<h3>Paket C</h3>
